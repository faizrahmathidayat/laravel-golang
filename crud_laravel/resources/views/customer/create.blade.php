    ...
    <div class="mt-3">
        ...
        <form>
            ...
            <div class="row mb-3 input-group">
                ...
                <div class="col-sm-10">
                    <input type="date" required name="cst_dob" id="cst_dob" class="form-control" value="0">
                    ...
                    <div class="card-body">
                        ...
                        <table id="tbl_users_access" class="table table-bordered table-striped">
                            ...
                            <tbody id="detail">
                                <tr id="row_0">
                                    <td>
                                        <input class="form-control" type="text" name="fl_relation[]" id="fl_relation_0">
                                    </td>
                                    <td>
                                        <input class="form-control" type="text" name="fl_name[]" id="fl_name_0">
                                    </td>
                                    <td>
                                        <input class="form-control" type="date" name="fl_dob[]" id="fl_dob_0">
                                    </td>
                                    <td>
                                        <button class="btn btn-sm btn-danger" type="button"
                                            onclick="hapusBaris(0)">Hapus</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
